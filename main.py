...
# global card_list, card_value, seleted_card_pc, seleted_card_user, flag, win, lose, draw
        ...
        while sum(seleted_card_user[1]) < 21 and user_answer == "y":
            ...
            if user_answer == "y":
                ...
                if sum(seleted_card_user[1]) < 21:
                    ...
                    print(
                        f"YOU LOSE! Becouse total your scope is {sum(seleted_card_user[1])}. You are having next cards {seleted_card_user[0]}. "
                    )
                    ...
                    print(
                        f"Your total scope is {sum(seleted_card_user[1])}. You are having next cards {seleted_card_user[0]}. "
                    )
                else:
                ...
                print(
                    f"PC total scope is {sum(seleted_card_pc[1])}. You are having next cards {seleted_card_pc[0]}."
                )
                if sum(seleted_card_user[1]) == sum(seleted_card_pc[1]):
                    print(
                        f"************\nDRAW! You and PC are having equal points {sum(seleted_card_user[1])}"
...
while flag:
    if win != 0 or lose != 0 or draw != 0:
        print(f"Ratio between your win / lose / draw is {win}/{lose}/{draw}.")
